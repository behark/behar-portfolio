...
export function SocialProof() {
    ...
    return (
        <section ref={ref} className="py-16 bg-gray-50 dark:bg-gray-800 transition-colors">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        {badges.map((badge, index) => {
                            ...
                            return (
                                <div
                                    key={index}
                                    className={`text-center ${inView ? 'animate-scaleIn' : ''} hover:scale-110 transition-transform duration-300`}
                                    style={{ animationDelay: `${index * 0.1}s` }}
                                >
                                    <div className="flex justify-center mb-2">
                                        <IconComponent className="w-10 h-10 text-blue-600 dark:text-blue-400 hover:scale-125 transition-transform duration-300" aria-hidden="true" />
                                    </div>
                ...
                <div className={`text-center mt-12 ${inView ? 'animate-fadeInUp' : ''}`} style={{ animationDelay: '0.6s' }}>
                    <div className="inline-flex items-center space-x-4 bg-white dark:bg-gray-900 px-6 py-3 rounded-full shadow-lg border border-gray-200 dark:border-gray-700">
